        ...
        <section style="margin:6%">
            <div class="row">
                    ...
                    <div class="single-service service__style--4 large-size text-center">
                        <a onclick='<?php
                                    if (strpos($user['services'], 'Intraday Calls') !== false) {
                                        echo 'redirect("http://subscription-admin/docs/' . $user['Intraday Calls'] . '")';
                                    } else {
                                        echo 'modal()';
                                    }
                                    ?>'>
                ...
                <div data-aos="fade-up" data-aos-duration="500" class="col-lg-6 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-service service__style--4 large-size text-center">
                        <a onclick='<?php
                                    if ($user['Short Term Calls']) {

                                        echo 'redirect("short.php")';
                                    } else {
                                        echo 'modal()';
                                    }
                                    ?>'>
                ...
                <div data-aos="fade-up" data-aos-duration="500" class="col-lg-6 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-service service__style--4 large-size text-center">
                        <a onclick='<?php
                                    if ($user['Investment Calls 1']) {

                                        echo 'redirect("invest.php")';
                                    } else {
                                        echo 'modal()';
                                    }
                                    ?>'>
                ...
                <div data-aos="fade-up" data-aos-duration="500" class="col-lg-6 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-service service__style--4 large-size text-center">
                        <a onclick='<?php
                                    if ($user['Investment Calls 2']) {

                                        echo 'redirect("invest2.php")';
                                    } else {
                                        echo 'modal()';
                                    }
                                    ?>'>
                ...
                <div data-aos="fade-up" data-aos-duration="500" class="col-lg-6 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-service service__style--4 large-size text-center">
                        <a onclick='<?php
                                    if ($user['Sectoral Calls']) {

                                        echo 'redirect("sect.php")';
                                    } else {
                                        echo 'modal()';
                                    }
                                    ?>'>
